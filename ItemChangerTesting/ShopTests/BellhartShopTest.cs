...
internal class BellhartShopTest : Test
{
    ...
    public override void Setup(TestArgs args)
    {
        ...
        Profile.AddPlacement(Finder.GetLocation(LocationNames.Frey)!.Wrap().Add(Finder.GetItem(ItemNames.Surgeon_s_Key)!.WithCost(new RosaryCost(123))));
        Profile.AddPlacement(Finder.GetLocation(LocationNames.Frey__Requires_Bellhome)!.Wrap().Add(Finder.GetItem(ItemNames.Ascendant_s_Grip)!.WithCost(new RosaryCost(234))));
    }
