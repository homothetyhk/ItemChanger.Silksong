...
public class ToolCountCost(int amount) : Cost, IShopDescTextCost
{
    ...
    public string ShopDescText() => GetCostText();

    public override bool HasPayEffects() => false;

    public override void OnPay() { }

    public static int Get(Cost cost) => cost.GetCostsOfType<ToolCountCost>().Select(c => c.Amount).DefaultIfEmpty().Max();
}
