...
public class ShakraModule : Module
{
    ...
    private void ModifyDialogueFsm(PlayMakerFSM fsm)
    {
        ...
        // Mark this location as visited as soon as the shop is checked.
        fsm.GetState("Shop has stock?")?.InsertMethod(0, _ => VisitedScenes.Add(GameManager.instance.sceneName));
    }
