...
internal static partial class BaseAtlasSprites
{
    ...
    public static AtlasSprite Generic_Crest = new AtlasSprite()
    {
        BundleName = "atlases_assets_assets/sprites/_atlases/inventory.spriteatlas",
        SpriteName = "Tools_UI_Crest_Change"
    };
    public static AtlasSprite Generic_Crest_Cursed = new AtlasSprite()
    {
        BundleName = "atlases_assets_assets/sprites/_atlases/inventory.spriteatlas",
    ...
    public static AtlasSprite Crest_of_Architect = new AtlasSprite()
    {
    ...
    public static AtlasSprite Crest_of_Beast = new AtlasSprite()
    {
        BundleName = "atlases_assets_assets/sprites/_atlases/area_art.spriteatlas",
        SpriteName = "Select_Game_Crest_Spools__0007_warrior"
    };
    public static AtlasSprite Crest_of_Cloakless = new AtlasSprite()//improve
    {
        BundleName = "atlases_assets_assets/sprites/_atlases/area_art.spriteatlas",
        SpriteName = "Select_Game_Crest_Spools__0000_hunter"
    };
    public static AtlasSprite Crest_of_Cursed_Witch = new AtlasSprite()
    {
        BundleName = "atlases_assets_assets/sprites/_atlases/area_art.spriteatlas",
        SpriteName = "Select_Game_Crest_Spools__0002_cursed"
    };
    public static AtlasSprite Crest_of_Hunter = new AtlasSprite()
    {
        BundleName = "atlases_assets_assets/sprites/_atlases/area_art.spriteatlas",
        SpriteName = "Select_Game_Crest_Spools__0000_hunter"
    };
    public static AtlasSprite Crest_of_Hunter__Upgrade_1 = new AtlasSprite()
    {
        BundleName = "atlases_assets_assets/sprites/_atlases/area_art.spriteatlas",
        SpriteName = "Select_Game_Crest_Spools__0003_hunter_v2"
    };
    public static AtlasSprite Crest_of_Hunter__Upgrade_2 = new AtlasSprite()
    {
        BundleName = "atlases_assets_assets/sprites/_atlases/area_art.spriteatlas",
        SpriteName = "Select_Game_Crest_Spools__0001_hunter_v3"
    };
    public static AtlasSprite Crest_of_Reaper = new AtlasSprite()
    {
        BundleName = "atlases_assets_assets/sprites/_atlases/area_art.spriteatlas",
        SpriteName = "Select_Game_Crest_Spools__0004_reaper"
    };
    public static AtlasSprite Crest_of_Shaman = new AtlasSprite()
    {
        BundleName = "atlases_assets_assets/sprites/_atlases/area_art.spriteatlas",
        SpriteName = "Select_Game_Crest_Spools__0005_shaman"
    };
    public static AtlasSprite Crest_of_Wanderer = new AtlasSprite()
    {
        BundleName = "atlases_assets_assets/sprites/_atlases/area_art.spriteatlas",
        SpriteName = "Select_Game_Crest_Spools__0008_wanderer"
    };
    public static AtlasSprite Crest_of_Witch = new AtlasSprite()
    {
        BundleName = "atlases_assets_assets/sprites/_atlases/area_art.spriteatlas",
        SpriteName = "Select_Game_Crest_Spools__0009_witch"
    };
    public static AtlasSprite Vesticrest_Blue = new AtlasSprite()
    {
        BundleName = "atlases_assets_assets/sprites/_atlases/inventory.spriteatlas",
        SpriteName = "UI_tool_slot_explore0001"
    };
    public static AtlasSprite Vesticrest_Yellow = new AtlasSprite()
    {
        BundleName = "atlases_assets_assets/sprites/_atlases/inventory.spriteatlas",
