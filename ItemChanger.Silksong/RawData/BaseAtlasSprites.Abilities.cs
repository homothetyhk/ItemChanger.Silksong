...
internal static partial class BaseAtlasSprites
{
    ...
    public static AtlasSprite Beastling_Call = new AtlasSprite()
    {
        BundleName = "atlases_assets_assets/sprites/_atlases/inventory.spriteatlas",
        SpriteName = "Inv_0029_spell_core_outer_icons_0000_1"
    };
    public static AtlasSprite Clawline = new AtlasSprite()
    {
        BundleName = "atlases_assets_assets/sprites/_atlases/inventory.spriteatlas",
        SpriteName = "Inv_0029_spell_core_outer_icons_0000_1_harpoon_dash"
    };
    public static AtlasSprite Cling_Grip = new AtlasSprite()
    {
        BundleName = "atlases_assets_assets/sprites/_atlases/inventory.spriteatlas",
        SpriteName = "Inv_0029_spell_core_outer_icons_0000_1_wall_jump"
    };
    public static AtlasSprite Elegy_of_the_Deep = new AtlasSprite()
    {
        BundleName = "atlases_assets_assets/sprites/_atlases/inventory.spriteatlas",
        SpriteName = "Inv_0029_spell_core_outer_icons_0000_1"
    };
    public static AtlasSprite Needolin = new AtlasSprite()
    {
        BundleName = "atlases_assets_assets/sprites/_atlases/inventory.spriteatlas",
        SpriteName = "Inv_0029_spell_core_outer_icons_0000_1"
    };
    public static AtlasSprite Silk_Soar = new AtlasSprite()
    {
        BundleName = "atlases_assets_assets/sprites/_atlases/inventory.spriteatlas",
        SpriteName = "Inv_0029_spell_core_outer_icons_0000_1_super_jump"
    };
    public static AtlasSprite Swift_Step = new AtlasSprite()
    {
        BundleName = "atlases_assets_assets/sprites/_atlases/inventory.spriteatlas",
        SpriteName = "Inv_0029_spell_core_outer_icons_0000_1_sprint"
    };
    public static AtlasSprite Sylphsong = new AtlasSprite()
    {
        BundleName = "atlases_assets_assets/sprites/_atlases/inventory.spriteatlas",
    ...
    public static AtlasSprite Drifter_s_Cloak = new AtlasSprite()
    {
        BundleName = "atlases_assets_assets/sprites/_atlases/inventory.spriteatlas",
        SpriteName = "I_spine_cloak"
    };
    public static AtlasSprite Faydown_Cloak = new AtlasSprite()
    {
        BundleName = "atlases_assets_assets/sprites/_atlases/inventory.spriteatlas",
        SpriteName = "I_crimson_cloak_down"
    };
    public static AtlasSprite Needle_Strike = new AtlasSprite()
    {
        BundleName = "atlases_assets_assets/sprites/_atlases/inventory.spriteatlas",
