...
public static class LocationNames
{
    ...
    public const string Lore_Tablet__Trobbio_Notes = "Lore_Tablet-Trobbio_Notes";  // Typically should roll into the quill location like world sense in HK
    // public const string Lore_Tablet__Trobbio_Notes_Act_3 = "Lore_Tablet-Trobbio_Notes_Act_3";  // This should be the same location as the act 2 one
